...
const menuItems = [
  ...
  { icon: HelpCircle, label: "Help", count: null, path: null },
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="w-20 h-20 rounded-full border-2 border-foreground/20 bg-secondary flex items-center justify-center">
